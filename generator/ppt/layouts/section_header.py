...
def render_section_header(
    ...
    if variant == 0:
        _render_section_left_bar(slide, data, theme, dna)
    elif variant == 1:
        _render_section_dark(slide, data, theme, dna)
    else:
        _render_section_numbered(slide, data, theme, dna)


def _render_section_left_bar(slide, data: dict, theme: ColorTheme, dna: DesignDNA) -> None:
    """变体 0: 左侧强调条 + 章节标题。"""
...
def _render_section_dark(slide, data: dict, theme: ColorTheme, dna: DesignDNA) -> None:
    """变体 1: 深色全幅背景。"""
...
def _render_section_numbered(slide, data: dict, theme: ColorTheme, dna: DesignDNA) -> None:
    """变体 2: 章节编号 + 标题。"""
    set_slide_bg(slide, theme.background)
